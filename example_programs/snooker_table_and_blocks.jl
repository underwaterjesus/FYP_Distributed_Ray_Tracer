...
pink_ball = make_sphere( Vector_3D(0, 0, -5.5), ball_radius, colour=PINK, diffuse=ball_diffuse, specular=ball_specular, shine=ball_shine, reflection=ball_reflection )
...
img4 = render_scene(scene, 3840, 2160, 60, 10)
#save( File(format"PNG", "snooker5.png"), img1 )
#save( File(format"PNG", "snooker2.png"), img2 )
#save( File(format"PNG", "snooker3.png"), img3 )
save( File(format"PNG", "example_image.png"), img4 )