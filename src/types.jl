...
function make_sphere( centre::Vector_3D, radius::Real ; colour::RGBA=RED, diffuse::Real=0.5, specular::Real=0,
...
return Sphere( centre, radius, colour, diffuse, specular, shine, reflection, transparency, refraction )
